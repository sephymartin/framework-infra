...
public class CustomLocalDateTimeDeserializer extends StdDeserializer<LocalDateTime> implements ContextualDeserializer {
    ...
    private CustomLocalDateTimeDeserializer(DateTimeFormatter _formatter, JsonFormat.Shape _shape) {
    ...
    protected CustomLocalDateTimeDeserializer withLeniency(Boolean leniency) {
        return new CustomLocalDateTimeDeserializer(this._formatter, this._shape);
    }
    ...
    protected CustomLocalDateTimeDeserializer withDateFormat(DateTimeFormatter formatter) {
        return new CustomLocalDateTimeDeserializer(formatter, null);
    }

    protected CustomLocalDateTimeDeserializer withShape(JsonFormat.Shape shape) {
        return new CustomLocalDateTimeDeserializer(null, shape);
    }
}
